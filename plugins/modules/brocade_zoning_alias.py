...
EXAMPLES = """
  ...
  vars:
    ...
    aliases:
      - name: alias_host_1
        members:
          - aa:bb:cc:dd:ee:ff:11:15
      - name: alias_target_1
        members:
          - aa:bb:cc:dd:ee:ff:11:17
      - name: alias_target_2
        members:
          - aa:bb:cc:dd:ee:ff:11:18
      - name: alias_target_3
        members:
          - aa:bb:cc:dd:ee:ff:11:19
    aliases_to_delete:
      - name: alias_target_1
      - name: alias_target_2
      - name: alias_target_3
...
from ansible_collections.brocade.fos.plugins.module_utils.brocade_connection import login, logout
