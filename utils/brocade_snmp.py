...
def v1_trap_patch(
    login, password, fos_ip_addr, fos_version, is_https, auth, vfid, result, v1_traps, ssh_hostkeymust, timeout
):
    """
...
def v3_trap_patch(
    login, password, fos_ip_addr, fos_version, is_https, auth, vfid, result, v3_traps, ssh_hostkeymust, timeout
):
    """
    update existing user config configurations
