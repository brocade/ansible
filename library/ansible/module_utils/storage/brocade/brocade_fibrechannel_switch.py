...
from brocade_url import url_get_to_dict, url_patch, HTTP, HTTPS, url_patch_single_object
from brocade_ssh import ssh_and_configure
...
def fc_switch_get(login, password, fos_ip_addr, fos_version, is_https, auth, vfid, result):
    """
