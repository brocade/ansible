...
#        })
    ...
    if ((int(mode) == 1 and result.peek_enabled_state() ==
        pyfos_switchfcport.ENABLED_STATE_TYPE.OFFLINE) or
        (int(mode) == 0 and result.peek_enabled_state() ==
        pyfos_switchfcport.ENABLED_STATE_TYPE.ONLINE)):
        changed = True
