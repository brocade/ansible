...
def main():
    ...
    argument_spec = dict(
        ...
        cert=dict(required=True, type='dict'))
    ...
    singleton_helper(module, fos_ip_addr, fos_user_name, fos_password, https, ssh_hostkeymust, throttle, vfid, "brocade_security", "security_certificate_action", 300, cert, result)
